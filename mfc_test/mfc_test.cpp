...
// mfc_test.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cmfc_testApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cmfc_testApp::OnAppAbout)
END_MESSAGE_MAP()


// создание Cmfc_testApp
...
Cmfc_testApp::Cmfc_testApp()
{
	...
	SetAppID(_T("mfc_test.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cmfc_testApp

Cmfc_testApp theApp;


// инициализация Cmfc_testApp
...
// обработчики сообщений Cmfc_testApp
...
void Cmfc_testApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Cmfc_testApp настройка методов загрузки и сохранения

void Cmfc_testApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cmfc_testApp::LoadCustomState()
{
}

void Cmfc_testApp::SaveCustomState()
{
}
